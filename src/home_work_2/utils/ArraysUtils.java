...
public class ArraysUtils {
    ...
    /**
     * метод arrayRandom принимает массив с двумя параметрами и возвращает заполненный рандомными числами
     * @param size принимает размер массива
     * @param maxValueExclusion заполняет массив рандомными числами
     * @return возвращает заполненный рандомными числами массив
     */
